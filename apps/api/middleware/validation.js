...
export const productSchema = z.object({
  ...
  url: z.string().max(500, 'URL too long').optional(),
  buttonUrl: z.string().max(500, 'Button URL too long').optional(),
  image: z.string().max(500, 'Image URL too long').optional(),
  imageUrl: z.string().max(500, 'Image URL too long').optional(),
  ...
  {
    message: "Product must have either name or title",
  }
);
