// apps/generatorv2/src/services/imageUploadService.js
  ...
  if (!url || !key) {
    throw new Error(
      "[GEN] Missing SUPABASE_URL or SUPABASE_SERVICE_ROLE_KEY. " +
        "Set these on the generator service (or in apps/generatorv2/.env for dev)."
    );
  }

  return createClient(url, key, {
    auth: { persistSession: false },
    global: { headers: { "x-application-name": "irios-generatorv2" } },
  });
}
